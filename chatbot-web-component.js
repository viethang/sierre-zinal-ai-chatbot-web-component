 ...
 */
const T = globalThis, D = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Y = Symbol(), k = /* @__PURE__ */ new WeakMap();
let ht = class {
  constructor(t, e, s) {
...
const tt = (r) => new ht(typeof r == "string" ? r : r + "", void 0, Y), lt = (r, t) => {
  if (D)
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: at, defineProperty: ct, getOwnPropertyDescriptor: dt, getOwnPropertyNames: pt, getOwnPropertySymbols: $t, getPrototypeOf: ut } = Object, f = globalThis, W = f.trustedTypes, _t = W ? W.emptyScript : "", M = f.reactiveElementPolyfillSupport, b = (r, t) => r, j = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? _t : null;
      break;
  ...
  return e;
} }, et = (r, t) => !at(r, t), V = { attribute: !0, type: String, converter: j, reflect: !1, hasChanged: et };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, N = C.trustedTypes, q = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, st = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, it = "?" + _, ft = `<${it}>`, y = document, P = () => y.createComment(""), x = (r) => r === null || typeof r != "object" && typeof r != "function", rt = Array.isArray, At = (r) => rt(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", z = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Z = /-->/g, J = />/g, A = RegExp(`>|${z}(?:([^\\s"'>=/]+)(${z}*=${z}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), K = /'/g, F = /"/g, nt = /^(?:script|style|textarea|title)$/i, mt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), yt = mt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), G = /* @__PURE__ */ new WeakMap(), m = y.createTreeWalker(y, 129);
function ot(r, t) {
...
const gt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; $ < h.length && (n.lastIndex = $, p = n.exec(h), p !== null); )
      $ = n.lastIndex, n === S ? p[1] === "!--" ? n = Z : p[1] !== void 0 ? n = J : p[2] !== void 0 ? (nt.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = A) : p[3] !== void 0 && (n = A) : n === A ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? A : p[3] === '"' ? F : K) : n === F || n === K ? n = A : n === Z || n === J ? n = S : (n = A, i = void 0);
    const u = n === A && r[a + 1].startsWith("/>") ? " " : "";
    o += n === S ? h + ft : l >= 0 ? (s.push(c), h.slice(0, l) + st + h.slice(l) + _ + u) : h + _ + (l === -2 ? a : u);
  }
      ...
      if (i.nodeType === 1) {
        if (i.hasAttributes())
          for (const l of i.getAttributeNames())
            if (l.endsWith(st)) {
              const $ = p[n++], u = i.getAttribute(l).split(_), O = /([.?@])?(.*)/.exec($);
              h.push({ type: 1, index: o, name: O[2], strings: u, ctor: O[1] === "." ? Et : O[1] === "?" ? St : O[1] === "@" ? bt : R }), i.removeAttribute(l);
            } else
...
class vt {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (n === h.index) {
        let c;
        h.type === 2 ? c = new H(o, o.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (c = new Ct(o, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class H {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), x(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== v && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : At(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _$AC(t) {
    ...
    return e === void 0 && G.set(t.strings, e = new U(t)), e;
  }
  k(t) {
...
I == null || I(U, H), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.1.3");
const wt = (r, t, e) => {
...
}, xt = ":host{font-size:12px}";
var Ut = Object.defineProperty, Ht = Object.getOwnPropertyDescriptor, Ot = (r, t, e, s) => {
...
let Q = class extends w {
  ...
  render() {
    return yt`
      <div>Hello. I'm Sierre-Zinal AI bot
        </div>
    `;
  }
};
Q = Ot([
  Pt("sierre-zinal-ai-chatbot")
], Q);
export {
  Q as SierreZinalAIChatbot
};
